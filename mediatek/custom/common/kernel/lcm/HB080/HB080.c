...
static void lcm_init(void)
{
    ...
    lcm_util.set_gpio_out(GPIO14, GPIO_OUT_ONE); // LCM_STBY
    MDELAY(5);
    ...
    MDELAY(5);
    lcm_util.set_gpio_mode(GPIO84, GPIO_MODE_00);    
    lcm_util.set_gpio_dir(GPIO84, GPIO_DIR_OUT);
    lcm_util.set_gpio_out(GPIO84, GPIO_OUT_ONE); // LVDS_SHUTDOWN_N   
    MDELAY(120);
...
static void lcm_suspend(void)
{
    ...
    lcm_util.set_gpio_mode(GPIO84, GPIO_MODE_00);    
    lcm_util.set_gpio_dir(GPIO84, GPIO_DIR_OUT);
    lcm_util.set_gpio_out(GPIO84, GPIO_OUT_ZERO); // LVDS_SHUTDOWN_N      
    MDELAY(10);
    lcm_util.set_gpio_mode(GPIO14, GPIO_MODE_00);    
    lcm_util.set_gpio_dir(GPIO14, GPIO_DIR_OUT);
    lcm_util.set_gpio_out(GPIO14, GPIO_OUT_ZERO); // LCM_STBY     
    MDELAY(10);
    lcm_util.set_gpio_mode(GPIO49, GPIO_MODE_00);    
    lcm_util.set_gpio_dir(GPIO49, GPIO_DIR_OUT);
