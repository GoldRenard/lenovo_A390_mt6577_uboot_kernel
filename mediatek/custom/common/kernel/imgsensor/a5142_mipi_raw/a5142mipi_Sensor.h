...
#define CURRENT_MAIN_SENSOR                A5142MIPI_MICRON
...
#define A5142MIPI_WRITE_ID_1	0x20
#define A5142MIPI_READ_ID_1	0x21
#define A5142MIPI_WRITE_ID_2	0x30
#define A5142MIPI_READ_ID_2	0x31
...
#define A5142MIPI_FRAME_RATE_UNIT		10
#define A5142MIPI_set_frame_rate(a) 	(a * A5142MIPI_FRAME_RATE_UNIT)
#define A5142MIPI_1X_ZOOM_IN_CAPTURE_FRAME	9
...
/* FRAME RATE */
#define A5142MIPI_FPS(x)                          ((kal_uint32)(10 * (x)))
