 ...
 * $Log:$
 *
 * 09 14 2012 qihao.geng
 * [ALPS00358510] [Camera Driver] OV5647 Parallel Sensor Driver Revise Shutter function
 * .
 *
 * 07 30 2012 qihao.geng
 * [ALPS00321313] OV5647 raw µ÷ÊÔÐ§¹û
 * Revise the sensor diver code, remove name.
 * Review: http://mtksap20:8080/go?page=NewReview&reviewid=38235
 *
 *------------------------------------------------------------------------------
...
#define OV5647_IMAGE_SENSOR_PV_WIDTH           (1280 - 16)
#define OV5647_IMAGE_SENSOR_PV_HEIGHT          (960 - 12)
