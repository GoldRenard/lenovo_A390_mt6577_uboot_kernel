 ...
 * $Log:$
 *
 * 09 04 2012 hanli.huang
 * [ALPS00348663] [Need Patch] [Build Error]  ALPS.Wxx.xx Build Error for
 * for ics2 check in 
 * Review: http://mtksap20:8080/go?page=NewReview&reviewid=42262
 *
 * 07 11 2011 jun.pei
...
BOOL HI704_set_param_wb(UINT16 para)
{
    ...
    case AWB_MODE_OFF:
        ...
        HI704_write_cmos_sensor(0x03, 0x22);
        HI704_write_cmos_sensor(0x10, 0x72);
        }
        break;
    default:
        return FALSE;
...
void HI704_set_AE_mode(UINT32 iPara)
{
    ...
    {
        // turn off AEC/AGC
        HI704_write_cmos_sensor(0x10,temp_AE_reg &~ 0x80);
    }	
    else
    {
        HI704_write_cmos_sensor(0x10,temp_AE_reg | 0x80);
