...
void fan5405_set_ac_current(void)
{
    ...
    fan5405_config_interface_liao(0x06,0x10); //set ISAFE
	 ...
	 {
		  // fan5405_set_low_chg(1);  //limit output current control to 325mA
     ...
     {
          //fan5405_set_low_chg(0);  //release limitation of 325mA  FAN_CON5
	...
	{    
		...
		{   
			         ...
			         else 
			         {
			            fan5405_config_interface_liao(0x05,0x04);
			           // fan5405_set_ac_charging_current(0x02);
                                    fan5405_config_interface_liao(0x04,0x29); //set IOCHARGE
			            fan5405_config_interface_liao(0x01,0x78);
