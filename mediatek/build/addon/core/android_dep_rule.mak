...
ifeq (yes,$(strip $(MTK_EMMC_SUPPORT_OTP)))
  ifeq (no,$(strip $(MODEM_OTP_SUPPORT)))
...
ifneq ($(strip $(EVDO_DT_SUPPORT)),yes)
  ifeq ($(strip $(EVDO_DT_AGPS_SUPPORT)),yes)
     $(call dep-err-ona-or-offb, EVDO_DT_SUPPORT, EVDO_DT_AGPS_SUPPORT)
  endif
endif
############################################################
...
ifdef OPTR_SPEC_SEG_DEF
  ifneq (NONE,$(strip $(OPTR_SPEC_SEG_DEF)))
    ifneq (no,$(strip $(MTK_NETWORK_TYPE_ALWAYS_ON)))
      $(call dep-err-common, PLEASE turn off MTK_NETWORK_TYPE_ALWAYS_ON when OPTR_SPEC_SEG_DEF is not NONE)
    endif
  endif
endif
##############################################################
